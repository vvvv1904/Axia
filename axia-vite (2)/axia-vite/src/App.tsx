...
const INDUSTRY_CARDS: { icon: typeof FileCheck; title: string; desc: string; category: "freelancer" | "agency" }[] = [
  ...
  { icon: UserCheck, title: "Staffing Agencies", desc: "Track contractor hours across placements. Verified timesheets, automated billing.", category: "agency" },
...
function ReferralPopup({ isOpen, onClose, position, referralCode, referralCount }: {
  ...
  const shareOn = useCallback((platform: string) => {
    const text = "I just joined the Axia waitlist! One tab for your entire business — CRM, billing, and verified work logs. Get early access:";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#eef0f4] dark:bg-[#030619] flex flex-col transition-colors duration-300">
      ...
      <nav className="w-full border-b border-[#dfe4eb] dark:border-[#1a2444]/80 bg-[#eef0f4]/90 dark:bg-[#060d20]/90 backdrop-blur-md sticky top-0 z-50" role="navigation" aria-label="Main navigation">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14 sm:h-16">
          <div className="flex items-center gap-3">
            <a href="/" className="flex items-center gap-3" aria-label="Axia — Home">
      ...
      <main className="flex-1 w-full" role="main" itemScope itemType="https://schema.org/SoftwareApplication">
        {/* ═══════ SECTION 1 — HERO with mesh gradient ═══════ */}
        <section className={`w-full ${theme === "dark" ? "hero-gradient-dark" : "hero-gradient-light"} relative overflow-hidden`} aria-label="Hero">
        ...
        <section className="w-full border-t border-[#c8ced8] dark:border-[#1a2444]/60 bg-[#eef0f4] dark:bg-[#030619]" aria-label="Industries we serve">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
            <div className="text-center mb-8 sm:mb-12">
              ...
              {/* SEO: H2 for "Built For You" section — describes who Axia serves */}
        ...
        {/* ═══════ SECTION 2 — FEATURES ═══════ */}
        <section className="w-full border-t border-[#dfe4eb] dark:border-[#1a2444]/60 bg-[#f4f5f8] dark:bg-[#060d20]" aria-label="Features">
        ...
        <section className="w-full border-t border-[#dfe4eb] dark:border-[#1a2444]/60 bg-[#f4f5f8] dark:bg-[#030619]" aria-label="Before and after comparison">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-28">
        ...
        <section className="w-full border-t border-[#dfe4eb] dark:border-[#1a2444]/60 bg-[#f4f5f8] dark:bg-[#060d20]" aria-label="Truth Layer verification">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-28">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 sm:mb-12">
                <div className="bg-white dark:bg-[#0a1128] border border-[#dfe4eb] dark:border-[#1a2444] rounded-xl p-5 sm:p-6 shadow-lg shadow-black/[0.08] dark:shadow-black/20">
                  ...
                  <ul className="space-y-3">
                    {["Proposals & contracts", "Basic billing", "Payment collection", "Template library"].map((item) => (
                ...
                <div className="bg-white dark:bg-[#0a1128] border border-axia-gold/20 rounded-xl p-5 sm:p-6 relative shadow-lg shadow-black/[0.08] dark:shadow-black/20">
                  ...
                  <ul className="space-y-3">
                    {["Proposals & contracts", "Validated Billing", "Payment collection", "Template library", "Verified Workstreams", "Automated context capture", "Dispute-proof billing"].map((item) => (
        ...
        <section className="w-full border-t border-[#dfe4eb] dark:border-[#1a2444]/60 bg-[#f4f5f8] dark:bg-[#030619]" aria-label="Time and money saved">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-28">
        ...
        {/* ═══════ SECTION 6 — PRICING ═══════ */}
        <section className="w-full border-t border-[#dfe4eb] dark:border-[#1a2444]/60 bg-[#f4f5f8] dark:bg-[#060d20]" aria-label="Pricing plans">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-28">
        ...
        <section className="w-full border-t border-[#dfe4eb] dark:border-[#1a2444]/60 bg-[#f4f5f8] dark:bg-[#030619]" aria-label="Referral rewards">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-28">
        ...
        <section className="w-full border-t border-[#dfe4eb] dark:border-[#1a2444]/60 bg-axia-gold/[0.15] dark:bg-[#030619]" aria-label="Get early access">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-28">
      ...
      {/* ─── Footer — theme-aware ─── */}
      <footer className="border-t border-[#dfe4eb] dark:border-[#1a2444]/60 bg-[#f4f5f8] dark:bg-[#060d20]" role="contentinfo">
